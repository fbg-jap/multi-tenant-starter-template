...
3. Register an account on [Stack Auth](https://stack-auth.com), copy the keys from the dashboard, and paste them into `.env.local`. Then enable "client team creation" on the team settings tab.
